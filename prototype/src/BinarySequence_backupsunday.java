...
public class BinarySequence_backupsunday {
	
	private String sequence;
	
	public BinarySequence_backupsunday(String sequence)
	{
	...
	{
		String binary = intToBinary(val);
		assert binary.length() <= buffer : "value cannot fit into a " + buffer + " bit buffer!";
